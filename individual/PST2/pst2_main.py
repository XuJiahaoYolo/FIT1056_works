...
def remove_student(student_id):
    ...
    found = False
    for i in range(len(app_data["students"])):
        if app_data["students"][i]["id"] == student_id:
            del app_data["students"][i]
            found = True
...
def remove_teacher(teacher_id):
    """Remove a teacher from the data store."""
    found = False
    for i in range(len(app_data["teachers"])):
        if app_data["teachers"][i]["id"] == teacher_id:
            del app_data["teachers"][i]
            found = True
...
def update_student(student_id, **fields):
    """Find a student by ID and update their data."""
